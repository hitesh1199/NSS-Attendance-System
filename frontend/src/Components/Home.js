...
function Home() {
    ...
    const handleReportClickActive = () => {
        ...
        XLSX.utils.book_append_sheet(workbook, worksheet, 'Active Event List Report');
                ...
                <div className="container">
                    <div className="row">
                        <div className="col-12 d-flex justify-content-between align-items-center">
                            <div className="mb-2">
                                Showing <b>{displayedEntries.length}</b> out of <b>{pastEventEntries.length}</b> entries
                            </div>
