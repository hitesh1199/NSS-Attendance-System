...
const AdminHeader = () => {
    ...
    const formatDateTimePickerEdiit = (dateTimeString) => {
        ...
        const convertedDateTime = moment.tz(dateTimeString, indiaTimeZone).format(format);
                            ...
                            <tbody id="tbody">
                                {displayedEntries.map((student, index) => (
                                    <tr key={index}>
                                        ...
                                        <td><Link to={`/showCurrentEvent/${student._id}`}>
                                            {student.eventName}
                                        </Link></td>
                            ...
                            <Modal.Body>
                                ...
                                <form onSubmit={handleEdit}>
                                    ...
                                    <div className="form-group">
                                        ...
                                        <input type="text" id="eventName" className="form-control"  name="eventName" value={formDataInEditModel.eventName} onChange={handleInputChangeInEditModel} />
                                    </div>

                                    <div className="form-group">
                                        <label htmlFor="startDate">Event Start Date</label>
                                        <input type="datetime-local" id="startDate" class="form-control" name="startDate" value={formatDateTimePickerEdiit(formDataInEditModel.startDate)} onChange={handleInputChangeInEditModel} />
                                    </div>

                                    <div className="form-group">
                                        <label htmlFor="endDate">Event End Date</label>
                                        <input type="datetime-local" id="endDate" class="form-control" name="endDate" value={formatDateTimePickerEdiit(formDataInEditModel.endDate)} onChange={handleInputChangeInEditModel} />
                                    </div>
                            ...
                            <div className="container">
                                <div className="row">
                                    <div className="col-12 d-flex justify-content-between align-items-center">
                                        <div className="mb-2">
                                            Showing <b>{displayedEntries.length}</b> out of <b>{PastEventsEnteries.length}</b> entries
                                        </div>
