...
const ShowEvent = () => {
    ...
    const displayedEntries = filtered_Entries && Array.isArray(filtered_Entries)
                    ...
                    <div className="row mb-4">
                        ...
                        <div className="col-sm-6 d-flex align-items-center justify-content-end">
                            <div className="d-flex flex-wrap justify-content-end align-items-center">
                                <Button variant="primary" onClick={handleReportClick}>Generate Report</Button>
                            </div>
                        </div>
                    </div>
                            ...
                            <tbody id="tbody">
                                ...
                                {displayedEntries.map((student, index) => (
                                    <tr key={index}>
                                        ...
                                        <td>
                                            <button
                                                disabled={student.events.includes(event?.eventName)}  style={{ pointerEvents: 'none' }}
                                            >
